...
add_action('Flynt/afterRegisterComponents', function () {
    $page_components = [
        ...
        Components\LocationsFAQ\getACFLayout(),
        Components\LocationsFeatures\getACFLayout(),
        Components\LocationsMap\getACFLayout(),
        Components\LocationsCTA\getACFLayout(),
        Components\LocationsDepartments\getACFLayout(),
        Components\LocationsWhyCoburns\getACFLayout(),
        Components\LocationsStaff\getACFLayout(),
        Components\LocationsConsultation\getACFLayout(),
        Components\LocationsProducts\getACFLayout(),
        Components\LocationsTestimonials\getACFLayout(),
